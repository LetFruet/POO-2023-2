...
public class Funcionario2 {
    ...
    public double calcularIrpf() {
        ...
        if (salario <= 1903.98) {
            ...
            imposto = ((salario - 2826.65) * 0.15) + (922.67 * 0.075);
        } else if (salario <= 4664.68) {
            imposto = ((salario - 3751.05) * 0.225) + ((3751.05 - 2826.65) * 0.15) + (922.67 * 0.075);
        } else {
            imposto = ((salario - 4664.68) * 0.275) + ((4664.68 - 3751.05) * 0.225) + ((3751.05 - 2826.65) * 0.15) + (922.67 * 0.075);
        }
